...
<link rel="stylesheet"
	href="../sors/infor-4-21-0/css/theme-soho-contrast.css" />


<script src="../sors/infor-4-21-0/js/jquery-3.4.1.min.js"></script>


<script src="../sors/infor-4-21-0/js/d3.v4.min.js"></script>
<script src="../sors/infor-4-21-0/js/sohoxi.js"></script>
<script src="../sors/infor-4-21-0/js/sohoxi-migrate-4.4.0.js"></script>
...
<body class="no-scroll busy-loading-locale">
	...
	<%@include file="../sors/infor-4-21-0/svg/svg.html"%>
