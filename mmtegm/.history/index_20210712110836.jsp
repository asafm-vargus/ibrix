						...
						<div id="maincontentBalQuery" class="divsection" style="display: none;">
							...
							<div class="row">
								<div class="six columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpBqBARCODE" class="label">מנה:</label> <input type="text"
				...
				-->
						...
						<div id="maincontentMvl" class="divsection" style="display: none;">
							...
							<div class="row">
								<div class="six columns">
									<div class="field">
										<label for="inpMvlBARCODE" class="label">מנה:</label> <input type="text"
						...
						<div id="maincontentSmallBox" class="divsection" style="display: none;">
							...
							<div class="row">
								<div class="six columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpWHSL" class="label">איתור:</label> <input type="text"
											id="inpWHSL" class="lookup input-sm SmallBoxinputs " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
