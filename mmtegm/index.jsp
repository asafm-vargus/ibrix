<%@page import="java.util.*" %>
	<%@ include file="/sors/ServerInstace.jsp" %>
		...
		<head>
			<% if(session.getAttribute("apiusersession")==null ){ response.sendRedirect("login.jsp"); return; } %>
					...
					<% String orno=request.getParameter("orno"); if(orno==null) orno="" ; %>
						<% String ponr=request.getParameter("ponr"); if(ponr==null) ponr="" ; %>
							...
							<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
								...
								<link rel="stylesheet" href="../sors/infor-4-51-1/css/theme-soho-contrast.css" />
...
input:focus, input.is-focused
	/*14.5.20 makes selected input box even higher */ {
	border: solid 2px #004A99;
	box-shadow: 0 0 8px 4px rgba(41, 41, 41, 0.3);
	outline: none;
					...
					<header class="header is-personalizable mmt">
						<div class="toolbar" data-options="{maxVisibleButtons: 4}">
							<div class="title">
								...
								<button id="btnMenuHamburger" class="btn-icon application-menu-trigger" type="button">
									<span class="audible">Show navigation</span> <span class="icon app-header"> <span
											class="one"></span> <span class="two"></span> <span class="three"></span>
									</span>
								</button>
								<button id="btnHeaderBack" type="button" style="display: none"
									...
									<span class="audible">Show navigation</span> <span class="icon app-header go-back">
										<span class="one"></span>
...
-->
					...
					<section id="maincontent" class="page-container scrollable" role="main">
						...
						<div id="maincontentMainMenu" class="divsection busy" style="display: none;">
...
<div class="progress">
          ...
          -->
						...
						<div id="maincontentPickingMenu" class="divsection busy" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
								...
								<div class="six columns">
									<table>
										...
										<tr>
											<td>
												<div class="field-flex">
													<label for="inpWHLO" class="required label">מחסן: </label> 
													<input
								...
								<div class="six columns">
									...
									<div class="field-flex">
										...
										<button type="button" id="btnBigBox"
											...
											<span>Big Box</span> <span class="round ruby07 badge" style="color: #ffffff"
												id="bdgBigBox"></span>
										</button>
						...
						<div id="maincontentMoReport" class="divsection" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
							<div class="row">
								<div class="six columns">
									...
									<div class="field-flex">
										<label for="inpWHLOMoRinputs" class="required label">מחסן: </label> <input
											...
											placeholder="000" data-options='{ "pattern" : "###" }' autocomplete="off"
											aria-required="true" data-validate="required" value="" onchange="" /> <br />
										<span id="inpWHNM" class="data-description"></span>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="six columns">
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpMFNOMoRinputs" class="label">ה.ייצור:</label> <input type="text"
											id="inpMFNOMoRinputs" class="input-sm MoRinputs" autocomplete="off"
				...
				-->
							<div class="row">
								<div class="six columns">
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpMoWHSL" class="label">איתור:</label> <input type="text"
											id="inpMoWHSL" class="lookup input-sm MoRinputs " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
							...
							<div class="row">
								<div class="six columns">
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpMoREQA" class="label">כמות:</label> <input type="number"
											id="inpMoREQA" class="input-xs MoRinputs " autocomplete="off"
											aria-required="true" data-validate="" value="0" onchange="" />
									</div>
								</div>
				...
				-->
						...
						<div id="maincontentPoRecieve" class="divsection" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
							<div class="row">
								<div class="six columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpPUNO" class="label">הזמנת רכש:</label> <input type="text"
											id="inpPUNO" class="input-sm PoRinputs" autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>


									<div class="field-flex" style="margin-top: 2px">
										<label for="inpSUDO" class="label">תעודת משלוח:</label> <input type="text"
											id="inpSUDO" class="input-xs PoRinputs " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpITNO" class="label">מק"ט:</label> <input type="text" id="inpITNO"
											class="input-sm PoRinputs " autocomplete="off" aria-required="true"
											data-validate="" value="" onchange="" />
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpITDS" class="label">תיאור:</label> <span class="PoRspan"
											id="inpITDS"></span>
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpPNLI" class="label">שורה:</label> <input type="text" id="inpPNLI"
											class="input-xs PoRinputs " autocomplete="off" aria-required="true"
											data-validate="" value="" onchange="" />
									</div>
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpPUUN" class="label">יח':</label> <span id="inpPUUN"
											class="PoRspan"></span>
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpQA" class="label">כמות:</label> <input type="text" id="inpQA"
											class="input-xs PoRinputs " autocomplete="off" aria-required="true"
											data-validate="" value="" onchange="" />
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpORQA" class="label">כמות מוזמנת:</label> <span id="inpORQA"
											class="PoRspan"></span>
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpRVQA" class="label">כמות שהתקבלה:</label> <span id="inpRVQA"
											class="PoRspan"></span>
									</div>
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpWHSLPoRinputs" class="label">איתור:</label> <input type="text"
											id="inpWHSLPoRinputs" class="input-sm PoRinputs " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									...
									<div class="field">
										<input type="checkbox" class="checkbox" id="chxREND" /> <label for="chxREND"
											class="checkbox-label">סיום</label>
									</div>
						...
						<div id="maincontentBalQuery" class="divsection" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
							<div class="row">
								<div class="six columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpBqBARCODE" class="label">מנה/מק"ט:</label> <input type="text"
											id="inpBqBARCODE" class="input-sm BqRinputs" autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpBqWHSL" class="label">איתור:</label> <input type="text"
											id="inpBqWHSL" class="input-sm BqRinputs" autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpBqITDS" class="label">תיאור:</label> <span id="inpBqITDS"
											class="BqRinputs"></span>
									</div>
									...
									<div class="card">
										<div class="card-header">
											<h2 class="card-title">רשימת מנות
												<span class="round amethyst07 badge" style="color: #ffffff"
													id="bdgBalQueryCount"></span>
											</h2>
										...
										<div class="card-content">
											...
											<div class="listview" id="task-listview-whsl" style="display: none;"
												data-options="{'template': 'task-tmpl-whsl', 'selectable': 'false'}">
											</div>
											l
										</div>
									</div>
				...
				-->
						...
						<div id="maincontentMvl" class="divsection" style="display: none;">
							...
							<div class="row">
								<div class="six columns">
									<div class="field">
										<label for="inpMvlBARCODE" class="label">מנה\מק"ט:</label> 
										<input type="text" autofocus="true"
											id="inpMvlBARCODE" class="input-sm Mvlinputs" autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>
							...
							<div class="row">
								<div class="six columns">
									<div class="field">
										<label for="inpWHSLMvlinputs" class="label">איתור:</label> <input type="text"
											id="inpWHSLMvlinputs" class="lookup input-sm Mvlinputs " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
							...
							<div class="row">
								<div class="six columns">
									...
									<div class="field">
										<label for="inpTWSL" class="label">לאיתור:</label> <input type="text"
											id="inpTWSL" class="lookup input-sm Mvlinputs " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
				...
				-->
							...
							<div class="row">
								<div class="six columns">
									<div class="field" style="margin-top: 2px">
										<label for="inpMvlTRQT" class="label">כמות:</label> <input type="number"
											id="inpMvlTRQT" class="input-xs Mvlinputs " autocomplete="off"
											aria-required="true" data-validate="" value="0" onchange="" />
									</div>
							...
							<div class="row">
								<div class="six columns">
									...
									<button style="margin-top: 8px" type="button" class="btn-primary emerald07"
										onclick="mms177do()">
									...
									<button type="button" class="btn-icon" id="btnClear " onclick="clearMvlScreen()">
										<svg role="presentation" aria-hidden="true" focusable="false" class="icon">
											<use xlink:href="#icon-refresh"></use>
										</svg>
						...
						<div id="maincontentMoveConsol" class="divsection" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
							<div class="row">
								<div class="six columns">
									<table>
										...
										<tr>
											<td>
												<div class="field-flex">
													<label for="inpWHLOMvlConinputs" class="required label">מחסן:
													</label> <input type="text" id="inpWHLOMvlConinputs"
														class="input-xs MvlConinputs " placeholder="000"
														data-options='{ "pattern" : "###" }' autocomplete="off"
														aria-required="true" data-validate="required" value=""
														onchange="" /> <br /> <span id="inpWHNMMvlConinputs"
														class="data-description"></span>
												</div>
											</td>
											<td>
												<div class="field-flex" style="margin-top: 2px; width: 80px">
													<label for="inpDLIXMvlConinputs" class="label">מס.משלוח:</label>
													<input type="number" id="inpDLIXMvlConinputs"
														class="input-sm MvlConinputs" autocomplete="off"
														aria-required="true" data-validate="" value="" onchange="" />
												</div>
											</td>
										</tr>
							...
							<div class="row">
								<div class="six columns">
									<div class="field">
										<label for="inpWHSLMvlConinputs" class="label">איתור:</label> <input type="text"
											id="inpWHSLMvlConinputs" class="lookup input-sm MvlConinputs "
											autocomplete="off" aria-required="true" data-validate="" value=""
											onchange="" />
										<br /> <span id="inpSLDS" class="data-description MvlConinputs"></span>
								...
								<div class="two columns">
									<div class="field" style="margin-top: 2px">
										<label for="inpITNOMvlConinputs" class="label">מק''ט:</label> <span
											id="inpITNOMvlConinputs" class="MvlConinputs"
								...
								<div class="two columns">
									<div class="field" style="margin-top: 2px">
										<label for="inpITDSMvlConinputs" class="label">תיאור:</label> <span
											id="inpITDSMvlConinputs" class="MvlConinputs"
											style="font-size: 12px"></span>
									</div>
								...
								<div class="two columns">
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpALQTMvlConinputs" class="label">כמות:</label> <input
											type="number" id="inpALQTMvlConinputs" class="input-xs MvlConinputs"
											readonly autocomplete="off" aria-required="true" data-validate="" value=""
											onchange="" />
									</div>
								</div>
								<div class="two columns">
									<div class="field-flex" style="margin-top: 2px">
										<button type="button" id="btnMoveCon" class="btn-primary" onclick="mhs850do()">
							...
							<div class="row">
								...
								<button type="button" class="btn-icon" id="btnClear" onclick="clearMvlConScreen()">
									<svg role="presentation" aria-hidden="true" focusable="false" class="icon">
										<use xlink:href="#icon-refresh"></use>
									</svg>
						...
						<div id="maincontentSmallBox" class="divsection" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
							<div class="row">
								<div class="six columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpWHSL" class="label">איתור:</label> 
										<input type="text"
											id="inpWHSL" class="lookup input-sm SmallBoxinputs SmallBoxinputsRefresh" autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpSmallBoxBARCODE" class="label">מנה:</label> <input type="text"
											id="inpSmallBoxBARCODE"
											class="input-sm SmallBoxinputs SmallBoxinputsRefresh " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="lblRemain" class="label">יתרה:</label> <span id="lblRemain"
											class="SmallBoxinputs SmallBoxinputsRefresh"></span>
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="lblPacked" class="label">נארז:</label> <span id="lblPacked"
											class="SmallBoxinputs SmallBoxinputsRefresh"></span>
									</div>
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpSmallBoxTRQT" class="label">כמות:</label> <input type="number"
											id="inpSmallBoxTRQT" class="input-xs SmallBoxinputs SmallBoxinputsRefresh "
											autocomplete="off" aria-required="true" data-validate="" value=""
											onchange="" />
									</div>
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpSmallBoxPANR" class="label">מספר אריזה:</label> <input
											type="number" id="inpSmallBoxPANR" class="input-xs SmallBoxinputs "
											autocomplete="off" aria-required="true" data-validate="" value=""
											onchange="" />
									</div>
                    ...
                    <use xlink:href="#icon-refresh"></use>
								...
								-->
										...
										<div class="card-content" id="cardByItems" style="display: none;">
											<div class="card-group-action">
												<div class="flex-toolbar" role="toolbar"
													...
													<div class="toolbar-section title">
														רשימת מנות: <label for="inpPackCardITNO"
															class="label">מק"ט:</label>
											...
											<div class="listview" id="packLots-listview"
												data-options="{'template': 'packLots-tmpl', 'selectable': 'false'}">
											</div>
								...
								-->
											...
											<div class="listview" id="packContent-listview"
												data-options="{'template': 'packContent-tmpl', 'selectable': 'false'}">
											</div>
						...
						<div id="maincontentBigBoxDetails" class="divsection" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
								...
								<div class="six columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpDetailPANR" class="label">מספר אריזה:</label> <input
											type="number" id="inpDetailPANR" class="input-xs BigBoxDetailinputs "
											autocomplete="off" aria-required="true" data-validate="" value=""
											onchange="" />
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpBigBoxBARCODE" class="label">מנה:</label> <input type="text"
											id="inpBigBoxBARCODE" class="input-sm BigBoxDetailinputs  "
											autocomplete="off" aria-required="true" data-validate="" value=""
											onchange="" />
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpBigBoxITNO" class="label">פריט:</label> <input type="text"
											id="inpBigBoxITNO" class="input-sm BigBoxDetailinputs  " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>
									...
									<div class="field label-left">
										<span class="label">תיאור</span> <span class="data BigBoxDetailinputs "
											id="inpSmallBoxITDS"></span>
									</div>
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpBigBoxTRQT" class="label">כמות:</label> <input type="number"
											id="inpBigBoxTRQT" class="input-xs BigBoxDetailinputs  " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>
									...
									<div class="card" id="cardBigBoxDetails">
										...
										<div class="card-content">
											<div class="listview" id="bigboxpackDetail-listview"
												data-options="{'template': 'bigboxpackDetail-tmpl', 'selectable': 'false'}">
											</div>
										</div>
							...
							<div class="row">
								<div class="one-third column">
									<div class="card">
										<div class="card-header">
											<h2 class="card-title">
												בחר Big Box <span class="round ruby07 badge" style="color: #ffffff"
													id="bdgBigBoxCard"></span>
											</h2>
									...
									<span class="audible">רענן</span>
										...
										<div class="card-content">
											<div class="listview" id="bigboxpack-listview"
												data-options="{'template': 'bigboxpack-tmpl', 'selectable': 'false'}">
											</div>
										</div>
...
-->
						...
						<div id="maincontentMoPick" class="divsection" style="display: none;">
							...
							<div class="row">
								<div class="six columns">
									...
									<div class="field-flex">
										<label for="inpWHLO" class="required label">מחסן: </label> <input type="text"
											id="inpWHLO" class="input-xs MoPickinputs " placeholder="000"
											data-options='{ "pattern" : "###" }' autocomplete="off" aria-required="true"
											data-validate="required" value="" onchange="" /> <br /> <span id="inpWHNM"
											class="data-description"></span>
									</div>

									<div class="field-flex" style="margin-top: 2px">
										<label for="inpMFNO" class="label">ה.ייצור:</label> <input type="text"
											id="inpMFNO" class="input-sm MoPickinputs" autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>

									<div class="field-flex" style="margin-top: 2px; width: 80px">
										<label for="inpDLIX" class="label">מס.משלוח:</label> <input type="number"
											id="inpDLIX" class="input-sm MoPickinputs" autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>


									<button type="button" style="margin-top: 2px" class="btn-primary turquoise04"
										onclick="getMoPickDelivery()">בחר</button>
								...
								<div class="one-third column">
									<div class="card">
										<div class="card-header">
											...
											<button type="button" id="category-button"
												class="btn-icon btn-actions hide-focus turquoise04" tabindex="-1"
												onclick="getMoPickDelivery()">
												<svg class="icon" focusable="false" aria-hidden="true"
													role="presentation">
													<use xlink:href="#icon-refresh"></use>
												</svg>
										...
										<div class="card-content">
											<div class="listview" id="mopickDeliveries-listview"
												data-options="{'template': 'mopickDeliveries-tmpl', 'selectable': 'true'}">
											</div>
										</div>
									</div>
								</div>
						...
						<div id="maincontentMoPickDetails" class="divsection" style="display: none;">
							<div class="row" style="margin-top: 4px"></div>
											...
											<td>
												<div class="field-flex" style="width: 70px">
													<button type="button" style="margin-top: 2px"
														class="btn-primary turquoise04"
														onclick="MoPickIssue()">נפק</button>
												</div>
											</td>
										</tr>
									</table>
							...
							<div class="row">
								<div class="six columns">
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpMoPickTRQT" class="label">כמות:</label> <input type="number"
											id="inpMoPickTRQT" class="input-xs MoPickDetailInputs  " autocomplete="off"
											aria-required="true" data-validate="" value="" onchange="" />
									</div>
								</div>
							</div>
						...
						<div id="maincontentPhsInv" class="divsection" style="display: none;">
							...
							<div class="compound-field">
								...
								<div class="two columns">
									<div class="field" style="margin-top: 2px">
										<label for="ddlSTNB" class="label">מספר ספירה:</label> <select id="ddlSTNB"
											autocomplete="off" class="dropdown" data-init="false">
											...
											<div class="two columns">
												<div class="field-flex" style="margin-top: 2px; width: 100px">
													<label for="inpWHSLPhsInvinputs" class="label">איתור:</label> <input
														type="text" id="inpWHSLPhsInvinputs"
														class="input-sm PhsInvinputs " autocomplete="off"
														aria-required="true" data-validate="" value="" onchange="" />
											...
											<div class="two columns">
												<div class="field" style="margin-top: 2px">
													<label for="inpPhsITNO" class="label">מק''ט:</label> <span
														id="inpPhsITNO" class="PhsInvinputs"
														style="font-size: 12px"></span>
												</div>
											...
											<div class="two columns">
												<div class="field" style="margin-top: 2px">
													<label for="inpPhsITDS" class="label">תיאור:</label> <span
														id="inpPhsITDS" class="PhsInvinputs"
														style="font-size: 12px"></span>
												</div>
						...
						<div class="modal-body">
							<div class="row" style="margin-right: 14px; margin-left: 14px;">
									...
									<div class="two columns">
										<div class="field" style="margin-top: 2px">
											<label for="ddlCrtPACT" class="label">סוג אריזה:</label> <select
												id="ddlCrtPACT" autocomplete="off" class="dropdown" data-init="false">
								...
								<div class="compound-field">
									...
									<div class="two columns">
										<label for="inpCrtGRWE" class="label">משקל </label> <input type="number"
											id="inpCrtGRWE" autocomplete="off" class="input-xs mdlCrtBigbox" value=""
											onchange="" />
									</div>
								</div>
						...
						<div class="modal-body">
							<div class="row" style="margin-right: 14px; margin-left: 14px;">
								...
								<div class="compound-field">
									...
									<div class="two columns">
										<label for="inpITNOsearch" class="label">מק"ט </label> <input type="text"
											id="inpITNOsearch" class="input-mm findItemCarmel" value="" onchange="" />
									</div>
									<div class="four columns">
										<label for="inpITDSsearch" class="label">תיאור</label> <input type="text"
											id="inpITDSsearch" class="input-sm findItemCarmel" style="width: 300px"
											value="" onchange="" />
									</div>
									<div class="two columns">
										<label for="inpPOPNsearch" class="label">מק"ט לקוח</label> <input type="text"
											id="inpPOPNsearch" class="input-mm findItemCarmel" value="" onchange="" />
									</div>
								</div>

							</div>

							<div class="row" style="margin-right: 14px; margin-left: 14px; height: 500px">
								<div class="full-height full-width">
							...
							<div class="modal-buttonset">
								<button type="button" class="btn-modal" style="width: 50%;">בטל</button>
								<button type="button" id="btnfindItemCarmelOK" onclick="btnfindItemCarmelOKClicked()"
									class="btn-modal-primary" style="width: 50%;">הוסף</button>
							</div>
