...
function showMoPickDetails(){
	...
	if(gCurrentMoPickDelivery.PREVMSGN!=""){
		...
		var msg="Picking for delivery " + dlix + "/" + plsx + " already started on " + glob_convertAS400dateWithHyphen(gotMSGN.LMDT) + " by " + gotMSGN.CHID + "<br />";
		msg+="Would you like to continue or start over?";
...
function showMoPickDetailsList() {
	...
	var dataToSend = {
		usepool : 1,
		mie : "mie_VAR_searchPickingListLinesMat",
		cono : glob_ObjM3UserProp.CONO,
		whlo : whlo,
		ridi : dlix,
		plsx : plsx,
