...
<link rel="stylesheet"
	href="../sors/infor-4-31-1/css/theme-soho-contrast.css" />


<script src="../sors/infor-4-31-1/js/jquery-3.5.1.min.js"></script>


<script src="../sors/infor-4-31-1/js/d3.v5.min.js"></script>
<script src="../sors/infor-4-31-1/js/sohoxi.js"></script>
<script src="../sors/infor-4-31-1/js/sohoxi-migrate-4.4.0.js"></script>
...
<script src="MvlCon.js?_<%=n%>"></script>
...
<title>M3 Mobile Terminal</title>
</head>
...
<body class="no-scroll busy-loading-locale">
	...
	<%@include file="../sors/infor-4-31-1/svg/svg.html"%>
...
-->
					<h1 id="headerTitle">M3 Mobile Terminal</h1>
				</div>
...
-->
					...
					<div class="six columns">
						...
						<div class="field-flex">
							...
							<button type="button" class="btn-secondary-border full-width"
								style="text-align: left" onclick="showMvl()">
    ...
    <use xlink:href="#icon-transfer"></use>
								...
								<span>Movement. Change Loc – Balance ID</span>
				...
				<div class="row" style="margin-top: 12px">
					<div class="six columns">
						...
						<div class="field-flex">
							...
							<button type="button" class="btn-secondary-border full-width"
								style="text-align: left" onclick="showPoRecieve()">
				...
				<div class="row" style="margin-top: 12px">
					<div class="six columns">
						...
						<div class="field-flex">
							...
							<button type="button" class="btn-secondary-border full-width"
								style="text-align: left" onclick="showMoReport()">
								<span class="round amber07  badge">3</span>
								<svg role="presentation" aria-hidden="true" focusable="false"
									class="icon">
    <use xlink:href="#icon-manufacturing"></use>
  </svg>
								<span>Manufacture Order- Report Receipt</span>
							</button>
				...
				<div class="row" style="margin-top: 12px">
					<div class="six columns">
						...
						<div class="field-flex">
							...
							<button type="button" class="btn-secondary-border full-width"
								style="text-align: left" onclick="showMoveToConsol()">
...
-->
				...
				<div class="row" style="margin-top: 12px">
					<div class="six columns">
						...
						<div class="field-flex">
							...
							<button type="button" class="btn-secondary-border full-width"
								style="text-align: left" onclick="showMoPick()">
								<span class="round turquoise04  badge">6</span>
								<svg role="presentation" aria-hidden="true" focusable="false"
									class="icon">
    <use xlink:href="#icon-default"></use>
  </svg>
								<span>Picking (issue) - To Manufacture Order</span>
							</button>
				...
				<div class="row" style="margin-top: 12px">
					<div class="six columns">
						...
						<div class="field-flex">
							...
							<button type="button" class="btn-secondary-border full-width"
								style="text-align: left" onclick="showPhsInv()">
								<span class="round graphite05  badge">7</span>
								<svg role="presentation" aria-hidden="true" focusable="false"
									class="icon">
    <use xlink:href="#icon-doc-check"></use>
  </svg>
								<span>Physical Inventory Perform</span>
							</button>
				...
				<div class="row" style="margin-top: 12px">
					<div class="six columns">
						...
						<div class="field-flex">
							...
							<button type="button" class="btn-secondary-border full-width"
								style="text-align: left" onclick="showBalQuery()">
								<span class="round amethyst07  badge">8</span>
								<svg role="presentation" aria-hidden="true" focusable="false"
									class="icon">
    <use xlink:href="#icon-inventory"></use>
  </svg>
								<span>Balance Identity Inquiry</span>
							</button>
    ...
    <use xlink:href="#icon-logout"></use>
								...
								<span>Sign out <%=session.getAttribute("apiusersession") %></span>
							</button>
<!-- 
<div class="progress">
					...
					<div class="six columns">
						<table>
							...
							<tr>
								<td>
									<div class="field-flex">
										<label for="inpWHLO" style="margin-top: 2px; width: 80px" class="required label">Warehouse: </label> <input
											type="number" id="inpWHLO" class="input-xs Pickinputs "
								...
								<td>
									<div class="field-flex" >
										<label for="inpDLIX" class="label">Delivery No:</label> <input
				...
				<div class="row" style="margin-top: 12px">
					<div class="field-flex">
						<div class="field label-left">
							<span class="label">Customer</span> <span class="data Pickinputs"
								id="inpCONA"></span>
						</div>
					</div>
				</div>
			...
			<div id="maincontentMoReport" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">Warehouse: </label> <input
								type="number" id="inpWHLO" class="input-xs MoRinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
				...
				<div class="row">
					<div class="six columns">
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpMFNO" class="label">Manuf. Order:</label> <input
								type="number" wasType="text" id="inpMFNO" class="input-sm MoRinputs"
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
				...
				<div class="row">
					<div class="six columns">
						<div class="field label-left">
							<span class="label">Item</span> <span class="data MoRspan"
								id="inpMoITNO"></span>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="six columns">
						...
						<div class="field label-left">
							<span class="label">Description</span> <span class="data MoRspan"
								id="inpMoITDS"></span>
						</div>
					</div>
				</div>
						...
						<table>
							<tr>
								<td>
									...
									<div class="field-flex-sm" style="width:100px;">
										<span class="label">Ordered: </span> <span
											class="badge amber07 MoRspan" style="color: #ffffff";
											id="inpMoORQA"></span>
									</div>
								</td>
								<td>
									...
									<div class="field-flex">
										<label class="label">Reported: </label> <span
											class="badge amber07 MoRspan" style="color: #ffffff"
											id="inpMoMAQA"></span>
									</div>
								</td>
				...
				<div class="row">
					<div class="six columns">
					<div class="field-flex" style="margin-top: 2px">
										<label for="inpMoREQA" class="label">Quantity:</label> <input
				...
				<div class="row">
					<div class="six columns">
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpMoWHSL" class="label">Location:</label> <input
								type="text" wasType="text" id="inpMoWHSL" class="lookup input-sm MoRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpMoPartWHSL" class="label">Location חלקי:</label> <input
								type="number" wasType="text" id="inpMoPartWHSL"
				...
				<div class="row">
					<div class="six columns">
						<button type="button" id="btnPMS050" class="btn amber07 btnPMS050"
							onclick="pms050do()">Report</button>
			...
			<div id="maincontentPoRecieve" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">Warehouse: </label> <input
								type="number" id="inpWHLO" class="input-xs PoRinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpPUNO" class="label">Purchase Order:</label> <input
								type="number" wasType="text" id="inpPUNO" class="input-sm PoRinputs"
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpSUDO" class="label">Delivery Note:</label> <input
								type="number" wasType="text" id="inpSUDO" class="input-xs PoRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpITNO" class="label">Item:</label> <input
								type="text" wasType="text" id="inpITNO" class="input-sm PoRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="inpITDS" class="label">Description:</label> <span
								class="PoRspan" id="inpITDS"></span>
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="inpPNLI" class="label">Line:</label> <input
								type="number" wasType="text" id="inpPNLI" class="input-xs PoRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpPUUN" class="label">U/M:</label> <span
								id="inpPUUN" class="PoRspan"></span>
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="inpQA" class="label">Quantity:</label> <input type="number" wasType="text"
								id="inpQA" class="input-xs PoRinputs " autocomplete="off"
								aria-required="true" data-validate="" value="" onchange="" />
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="inpORQA" class="label">Ordered Quantity:</label> <span
								id="inpORQA" class="PoRspan"></span>
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="inpRVQA" class="label">Received Quantity:</label> <span
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpWHSL" class="label">Location:</label> <input
								type="text" wasType="text" id="inpWHSL" class="input-sm PoRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						...
						<div class="field">
							<input type="checkbox" class="checkbox" id="chxREND" /> <label
								for="chxREND" class="checkbox-label">Finish</label>
						</div>

						<button type="button" class="btn-primary turquoise07"
							onclick="pps001do()">Confirm</button>
			...
			<div id="maincontentBalQuery" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">Warehouse: </label> <input
								type="number" id="inpWHLO" class="input-xs BqRinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
...
<div class="field-flex" style="margin-top: 2px">
							<label for="inBqITNO" class="label">Item:</label> <input
								type="text" wasType="text" id="inBqITNO" class="input-sm BqRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpBqBARCODE" class="label">Lot:</label> <input
								type="number" wasType="text" id="inpBqBARCODE" class="input-sm BqRinputs"
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpBqITDS" class="label">Description:</label> <span
								id="inpBqITDS" class="BqRinputs"></span>
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="inpBqWHSL" class="label">Location:</label> <span
								id="inpBqWHSL" class="BqRinputs"></span>
						</div>


						<button type="button" class="btn-primary amethyst07"
							onclick="runBalQuery()">Show</button>
			...
			<div id="maincontentMvl" class="divsection" style="display: none;">
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">Warehouse: </label> <input
								type="number" id="inpWHLO" class="input-xs Mvlinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
				...
				<div class="row">
					<div class="six columns">
						<div class="field">
							<label for="inpMvlBARCODE" class="label">Lot:</label> <input
								type="number" wasType="text" id="inpMvlBARCODE" class="input-sm Mvlinputs"
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field">
							<label for="inpMvlITNO" class="label">Item:</label> <input
								type="text" wasType="text" id="inpMvlITNO" class="input-sm Mvlinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
				...
				<div class="row">
					<div class="six columns">
						<div class="field">
							<label for="inpWHSL" class="label">Location:</label> <input
								type="text" wasType="text" id="inpWHSL" class="lookup input-sm Mvlinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field">
							<label for="inpTWSL" class="label">To Location:</label> <input
								type="text" wasType="text" id="inpTWSL" class="lookup input-sm Mvlinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
				...
				<!-- 
					...
					<div class="six columns">
						...
						<div class="field" style="margin-top: 2px">
							<label for="inpMvlITDS" class="label">Description:</label> <span
				...
				<div class="row">
					<div class="six columns">
						<div class="field label-left">
							<span class="label">Item</span> <span class="data Mvlinputs"
								id="inpMvlITNOdesc"></span>
						</div>



						<div class="field label-left">
							<span class="label">Description</span> <span class="data Mvlinputs "
								id="inpMvlITDS"></span>
						</div>
				...
				<div class="row">
					<div class="six columns">
						<div class="field" style="margin-top: 2px">
							<label for="inpMvlTRQT" class="label">Quantity:</label> <input
						...
						<tr>
							<td>
								<div class="three columns">
									<label for="inpWHLO" class="required label">Warehouse: </label> <input
										type="number" id="inpWHLO" class="input-xs MvlConinputs "
										placeholder="000" data-options='{ "pattern" : "###" }'
										autocomplete="off" aria-required="true"
										data-validate="required" value="" onchange="" /> <br /> <span
										id="inpWHNM" class="data-description"></span>
    ...
    <use xlink:href="#icon-transfer"></use>
				...
				<div class="row">
					<div class="ten columns">
						<div class="field" style="margin-top: 2px">
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpWHSL" class="label">From Box:</label> <input
								type="text" wasType="text" id="inpWHSL" class="input-xs MvlConinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
								<span
										id="inpSLDS" class="data-description MvlConinputs"></span>
				...
				<div class="row">
					<div class="six columns">
						<div class="field" style="margin-top: 2px">
							<label for="ddlTWSL" class="label">Location consolidation:</label> <select
								id="ddlTWSL" class="dropdown"></select>
				...
				<div class="row">
					<div class="six columns">
						<!--style="margin-right: 14px; margin-left: 14px; height: 300px">-->
						<div class="full-height full-width">
							<div id="datagridMvlConsol" class="datagrid"></div>
			...
			<div id="maincontentSmallBox" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpWHSL" class="label">Location:</label> <input
								type="text" wasType="text" id="inpWHSL" class="lookup input-sm SmallBoxinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpSmallBoxBARCODE" class="label">Lot:</label> <input
								type="number" wasType="text" id="inpSmallBoxBARCODE"
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="lblRemain" class="label">Remain:</label> <span
								id="lblRemain" class="SmallBoxinputs "></span>
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="lblPacked" class="label">Packed:</label> <span
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpSmallBoxTRQT" class="label">Quantity:</label> <input
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpSmallBoxPANR" class="label">Box Number:</label> <input
				...
				<div class="row">
					<div class="one-third column">
						<div class="card">
							<div class="card-header">
								<h2 class="card-title" id="crdListLotsTitle" >Dsp Content</h2>
								...
								<div class="card-group-action">
									<div class="flex-toolbar" role="toolbar"
										...
										<div class="toolbar-section title">
											Lot List: <label for="inpPackCardITNO" class="label">Item:</label>
											<input type="text" wasType="text" id="inpPackCardITNO" class="input-sm  "
												autocomplete="off" aria-required="true" data-validate=""
												value="" onchange="" />
			...
			<div id="maincontentBigBoxDetails" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpDetailPANR" class="label">Box Number:</label> <input
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpBigBoxBARCODE" class="label">Lot:</label> <input
								type="number" wasType="text" id="inpBigBoxBARCODE"
								class="input-sm BigBoxDetailinputs  " autocomplete="off"
								aria-required="true" data-validate="" value="" onchange="" />
						</div>

						<div class="field-flex" style="margin-top: 2px">
							<label for="inpBigBoxITNO" class="label">Item:</label> <input
								type="text" wasType="text" id="inpBigBoxITNO"
								class="input-sm BigBoxDetailinputs  " autocomplete="off"
								aria-required="true" data-validate="" value="" onchange="" />
						</div>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpBigBoxTRQT" class="label">Quantity:</label> <input
				...
				<div class="row">
					<div class="one-third column">
						<div class="card">
							<div class="card-header">
								<h2 class="card-title">
									Select Big Box <span class="round ruby07 badge"
...
-->
			...
			<div id="maincontentMoPick" class="divsection" style="display: none;">
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">Warehouse: </label> <input
								type="number" id="inpWHLO" class="input-xs MoPickinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpMFNO" class="label">Manuf. Order:</label> <input
								type="number" wasType="text" id="inpMFNO" class="input-sm MoPickinputs"
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
						...
						<button type="button" style="margin-top: 2px"
							class="btn-primary turquoise04" onclick="getMoPickDelivery()">Go</button>
				...
				<div class="row">
					<div class="one-third column">
						<div class="card">
							<div class="card-header">
								<h2 class="card-title">
									Deliveries <span class="round turquoise04 badge"
			...
			<div id="maincontentMoPickDetails" class="divsection"
					...
					<div class="six columns" style="margin-top: 2px">
						<table>
							<tr>
								<td>
									<div class="field-flex">
										<label for="inpMoPickBARCODE" class="label">Lot:</label> <input
											type="number" wasType="text" id="inpMoPickBARCODE"
								...
								<td>
									<div class="field-flex" style="width: 70px">
										<button type="button" style="margin-top: 2px"
											class="btn-primary turquoise04" onclick="MoPickIssue()">Issue</button>
									</div>
								</td>
							</tr>
						</table>
				...
				<div class="row">
					<div class="six columns">
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpMoPickTRQT" class="label">Quantity:</label> <input
				...
				<div class="row">
					<div class="one-third column">
						<div class="card">
							<div class="card-header">
								<h2 class="card-title">
									Lines <span class="round turquoise04 badge"
			...
			<div id="maincontentPhsInv" class="divsection" style="display: none;">
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">Warehouse: </label> <input
								type="number" id="inpWHLO" class="input-xs PhsInvinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
				...
				<div class="compound-field">
					...
					<div class="two columns">
						<div class="field" style="margin-top: 2px">
							<label for="ddlSTNB" class="label">Phs. Inv. No:</label> <select
				...
				<div class="one-third column">
					<div class="card" id="cardPhsInv" style="display: none;">
						<div class="card-header">
							<h2 class="card-title">Physical Inventory</h2>
						...
						<div class="card-content">
							<div class="compound-field">
								...
								<div class="two columns">
									<div class="field-flex" style="margin-top: 2px; width: 100px">
										<label for="inpWHSL" class="label">Location:</label> <input
											type="text" wasType="text" id="inpWHSL" class="input-sm PhsInvinputs "
											autocomplete="off" aria-required="true" data-validate=""
											value="" onchange="" />
							...
							<div class="compound-field">
								...
								<div class="two columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpPhsBARCODE" class="label">Lot:</label> <input
											type="number" wasType="text" id="inpPhsBARCODE" class="input-sm PhsInvinputs"
											autocomplete="off" aria-required="true" data-validate=""
                 ...
                 <use xlink:href="#icon-error"></use>
											...
											id="spnPhsBanoError PhsInvinputs">Lot already counted </span>
							...
							<div class="compound-field">
								<div class="two columns">
									<div class="field" style="margin-top: 2px">
										<label for="inpPhsITNO" class="label">Item:</label> <span
								...
								<div class="two columns">
									<div class="field" style="margin-top: 2px">
										<label for="inpPhsITDS" class="label">Description:</label> <span
							...
							<div class="compound-field">
								...
								<div class="two columns">
									...
									<div class="field-flex" style="margin-top: 2px">
										<label for="inpPhsTRQT" class="label">Quantity:</label> <input
	...
	<div class="modal" id="modal-crtBigBox">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h1 class="modal-title">Create Pack</h1>
			</div>
			...
			<div class="modal-body">
				<div class="row" style="margin-right: 14px; margin-left: 14px;">
					...
					<div class="compound-field">
						...
						<div class="two columns">
							<label for="inpCrtPACT" class="label required">Type:
							</label> <input type="number" wasType="text" id="inpCrtPACT" class="input-xs mdlCrtBigbox"
					...
					<div class="compound-field">
						...
						<div class="two columns">
							<div class="field" style="margin-top: 2px">
								<label for="ddlCrtPACT" class="label">Type:</label> <select
					...
					<div class="compound-field">
						...
						<div class="two columns">
							<label for="inpCrtGRWE" class="label">Weight </label> <input
				...
				<div class="modal-buttonset">
					...
					<button type="button" id="btncrtBigBoxlOK" onclick="createBigBox()"
						class="btn-modal-primary" style="width: 50%;">Confirm</button>
				</div>
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Lot:{{MLBANO}}  </p>
   			 <p class="listview-subheading">Location:<b>{{MLWHSL}}</b> Stock Zone:{{MLSLTP}}</p>
              <p class="listview-micro">Quantity: {{MLSTQT2D}} Allocated: {{MLALQT2D}}</p>
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Stock Zone:{{SDSLTP}} </p>
				<p class="listview-subheading">{{MNARNM}} </p>
   			 <p class="listview-micro"><span class="round graphite05  badge">{{ITEMS_NUM}}</span>Items  </p>
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Box:<b>{{OSPANR}}</b> </p>

   			 <p class="listview-micro">Picked :<b>{{OSDLQT}}</b>Last user:<b>{{OSCHID}}</b></p>
             <!-- <p class="listview-micro">Quantity: {{MLSTQT}} Allocated: {{MLALQT}}</p>-->
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Lot:<b>{{OSBANO}}</b> 
...
<span>Unload</span>
   			 ...
   			 <p class="listview-subheading">Box:<b>{{OSPANR}}</b> Picked:<b>{{OSDLQT}}</b> </p>
              <p class="listview-micro">Order: <b>{{OSRIDN}}/{{OSRIDL}}</b> Last user:<b>{{OSCHID}}</b></p>
...
<span>Unpack</span>
   			 ...
   			 <p class="listview-subheading">Item:<b>{{OSITNO}}</b> Picked:<b>{{OSDLQT}}</b> </p>
              <p class="listview-micro">Order: <b>{{OSRIDN}}/{{OSRIDL}}</b> <font style="color:red">{{OTHERFLAG}}</font></p>
<p class="listview-micro">Last user:<b>{{OSCHID}}</b></p>
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Box:<b>{{ORPANR}}</b>
...
<span>Select</span>
   			 ...
   			 <p class="listview-subheading">Type :<b>{{ORPACT}}</b> {{M4PANM}}
</p>
 <p class="listview-micro">
 Weight:
 <input
            ...
            <p class="listview-micro">contains: <b>{{PACKED}}</b> packages </p>
<button type="button" class="btn-secondary-border  " id="btnClear"
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Box:<b>{{OSPANR}}</b> 
...
<span>Select</span>
   			 ...
   			 <p class="listview-subheading">Picked :<b>{{OSDLQT}}</b> Last user:<b>{{OSCHID}}</b></p>
             <!-- <p class="listview-micro">Quantity: {{MLSTQT}} Allocated: {{MLALQT}}</p>-->
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Lot:<b>{{MQBANO}}</b> 	Quantity:<b>{{MQTRQT2D}}</b>  	Issued:<b>{{G2DLQT2D}}</b>



</p>

   			 <p class="listview-subheading">Order :<b>{{MQRIDN}}/{{MQRIDL}}</b> Location:<b>{{MQWHSL}}</b></p>
              <p class="listview-micro"><b>{{MQITNO}}</b> {{MMITDS}}</p>
 <p class="listview-micro">Stock:<b>{{STQT}}</b> Allocated:{{ALQT}}</p>
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">Delivery:<b>{{OQDLIX}}/{{PIPLSX}}</b> 
          ...
          <svg class="icon" focusable="false" style="display:{{ISINPROG}}" aria-hidden="true" role="presentation">
            <use xlink:href="#icon-user-status-away"></use>
   			 ...
   			 <p class="listview-subheading">Date :<b>{{PIESPD}}</b></p>
