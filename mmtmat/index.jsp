			...
			<div id="maincontentMoReport" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">מחסן: </label> <input
								type="text" id="inpWHLO" class="input-xs MoRinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
					...
					<div class="six columns">
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpMFNO" class="label">ה.ייצור:</label> <input
								type="text" id="inpMFNO" class="input-sm MoRinputs"
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
			...
			<div id="maincontentPoRecieve" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">מחסן: </label> <input
								type="text" id="inpWHLO" class="input-xs PoRinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpWHSL" class="label">איתור:</label> <input
								type="text" id="inpWHSL" class="input-sm PoRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
			...
			<div id="maincontentBalQuery" class="divsection"
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">מחסן: </label> <input
								type="text" id="inpWHLO" class="input-xs BqRinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
...
<div class="field-flex" style="margin-top: 2px">
							<label for="inBqITNO" class="label">מק"ט:</label> <input
								type="text" id="inBqITNO" class="input-sm BqRinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						</div>
						<div class="field-flex" style="margin-top: 2px">
						...
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpBqWHSL" class="label">איתור:</label> <span
					...
					<div class="one-third column">
						<div class="card">
							<div class="card-header">
								<h2 class="card-title">רשימת מנות</h2>
			...
			<div id="maincontentMvl" class="divsection" style="display: none;">
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">מחסן: </label> <input
								type="text" id="inpWHLO" class="input-xs Mvlinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field">
							<label for="inpMvlITNO" class="label">מק"ט:</label> <input
								type="text" id="inpMvlITNO" class="input-sm Mvlinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
				...
				<div class="row">
					<div class="six columns">
						<div class="field">
							<label for="inpWHSL" class="label">איתור:</label> <input
								type="text" id="inpWHSL" class="lookup input-sm Mvlinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
						...
						<tr>
							<td>
								<div class="three columns">
									<label for="inpWHLO" class="required label">מחסן: </label> <input
										type="text" id="inpWHLO" class="input-xs MvlConinputs "
										placeholder="000" data-options='{ "pattern" : "###" }'
										autocomplete="off" aria-required="true"
										data-validate="required" value="" onchange="" /> <br /> <span
										id="inpWHNM" class="data-description"></span>
    ...
    <use xlink:href="#icon-transfer"></use>
				...
				<div class="row">
					<div class="ten columns">
						<div class="field" style="margin-top: 2px">
						<div class="field-flex" style="margin-top: 2px">
							<label for="inpWHSL" class="label">מארגז:</label> <input
								type="text" id="inpWHSL" class="input-xs MvlConinputs "
								autocomplete="off" aria-required="true" data-validate=""
								value="" onchange="" />
								<span
						...
						<!-- rem 12.4.20
							<label for="ddlWHSL" class="label">מארגז:</label> <select
								id="ddlWHSL" name="badge-test" class="dropdown">
...
-->
				...
				<div class="row">
					<div class="six columns">
						<div class="field" style="margin-top: 2px">
							<label for="ddlTWSL" class="label">איתור קונסולידציה:</label> <select
			...
			<div id="maincontentPhsInv" class="divsection" style="display: none;">
				...
				<div class="row">
					<div class="six columns">
						...
						<div class="field-flex">
							<label for="inpWHLO" class="required label">מחסן: </label> <input
								type="text" id="inpWHLO" class="input-xs PhsInvinputs "
								placeholder="000" data-options='{ "pattern" : "###" }'
								autocomplete="off" aria-required="true" data-validate="required"
								value="" onchange="" /> <br /> <span id="inpWHNM"
								class="data-description"></span>
							...
							<div class="compound-field">
								...
								<div class="two columns">
									<div class="field-flex" style="margin-top: 2px; width: 100px">
										<label for="inpWHSL" class="label">איתור:</label> <input
											type="text" id="inpWHSL" class="input-sm PhsInvinputs "
											autocomplete="off" aria-required="true" data-validate=""
											value="" onchange="" />
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">מנה:{{MLBANO}}  </p>
   			 <p class="listview-subheading">איתור:<b>{{MLWHSL}}</b> אזור מלאי:{{MLSLTP}}</p>
              <p class="listview-micro">כמות: {{MLSTQT2D}} מוקצה: {{MLALQT2D}}</p>
...
<span>בחר</span>
        ...
        <ul>
          {{#dataset}}
            ...
            {{/disabled}}
              ...
              <p class="listview-heading">מנה:<b>{{MQBANO}}</b> 	כמות:<b>{{MQTRQT2D}}</b>  	נופק:<b>{{G2DLQT2D}}</b>
 ...
 <p class="listview-micro">מלאי כללי:<b>{{STQT}}</b> מוקצה:{{ALQT}}</p>
