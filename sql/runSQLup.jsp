...
Map<String, String[]> parameters = request.getParameterMap();
   ...
   if(usePool.equals("1") && prop.getProperty("Driver").equals("com.ibm.as400.access.AS400JDBCDriver")){
	   ...
	   conn = DataSourceAS400.getInstance(prop.getProperty("ConnectioString"),USER,PASS).getConnection();// DriverManager.getConnection(prop.getProperty("ConnectioString"));
	   System.out.println("num of connections:" + DataSourceAS400.getInstance(prop.getProperty("ConnectioString"),USER,PASS).getNumConnections());
   }else{
    try {
